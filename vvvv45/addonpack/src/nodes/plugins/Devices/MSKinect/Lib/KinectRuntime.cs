...
namespace VVVV.MSKinect.Lib
{
    public class KinectRuntime
    {
        ...
        public void SetColor(bool enable, bool enableHD)
        {
            if (enable)
            {
                this.ColorImageFormat = enableHD?ColorImageFormat.RgbResolution1280x960Fps12:ColorImageFormat.RgbResolution640x480Fps30;
                this.Runtime.ColorStream.Enable(this.ColorImageFormat);
